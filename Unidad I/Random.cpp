...
int main()
{
    ...
    cin >> nroAleatorios;
    cout << "En que valor INICIARA el n�mero aleatorio: ";
    cin >> valorInicial;
    cout << "En que valor FINALIZARA el n�mero aleatorio: ";
    cin >> valorFinal;
    ...
    for (int i = 0; i < 6; i++)
    {
        cout << "La cara con el n�mero " << i + 1 << " ha salido " << vectorDado[i] << " veces." << endl;
